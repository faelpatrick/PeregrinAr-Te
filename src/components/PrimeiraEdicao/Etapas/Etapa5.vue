<template>
    <v-container>
        <div class="primeiro-texto">
            ...
            <br>
            <div class="img-container">
                <img src="@/assets/imagens/Cristo IV.jpg" alt="" class="ma-5" aspect-ratio="1" @click="mostrar($event)"
                    style="max-width: 300px; cursor: pointer;"></img>
            </div>
            <div class="img-desc">
            ...
            <br>
            <div class="img-container">
                <img src="@/assets/imagens/Cristo VI  1.jpg" alt="" class="ma-5" aspect-ratio="1"
                    @click="mostrar($event)" style="max-width: 300px; cursor: pointer;"></img>
                <img src="@/assets/imagens/Cristo VI 2.jpg" alt="" class="ma-5" aspect-ratio="1"
                    @click="mostrar($event)" style="max-width: 300px; cursor: pointer;"></img>
            </div>
            <div class="img-desc">
                <span class="img-titulo">Cristo VI</span>
                <span class="img-autor">Óleo s/ platex</span>
            </div>
            <br>
            <div class="img-container">
                <img src="@/assets/imagens/Cristo VII 1.jpg" alt="" class="ma-5" aspect-ratio="1" @click="mostrar($event)"
                    style="max-width: 300px; cursor: pointer;"></img>
                    <img src="@/assets/imagens/Cristo VII 2.jpg" alt="" class="ma-5" aspect-ratio="1" @click="mostrar($event)"
                    style="max-width: 300px; cursor: pointer;"></img>
            </div>
            <div class="img-desc">
                <span class="img-titulo">Cristo VII</span>
                <span class="img-autor">Óleo s/ cartão</span>
            </div>
            <br>
            <div class="img-container">
                <img src="@/assets/imagens/Cristo VIII.jpg" alt="" class="ma-5" aspect-ratio="1" @click="mostrar($event)"
                    row style="max-width: 300px; cursor: pointer;"></img>
            </div>
            <div class="img-desc">
                <span class="img-titulo">Cristo VIII</span>
            ...
            <div class="img-desc">
                <span class="img-titulo">Sol, Grade e Corpo</span>
                <span class="img-autor">Óleo s/ tela</span>
            </div>
            <br>
            <div class="img-container">
